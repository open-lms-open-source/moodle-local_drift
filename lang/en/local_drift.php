...
$string['drift_clientkey_desc'] = 'Client secret key provides by Drift.';
...
$string['drift_usersubscription_policy'] = 'If the user authorize to receive messages in its account from Drift. It is required to send its name, email, country, language and role to Drift platform.';